...
- **feat(frontend):** home page gains an editorial-gaps card — top 5 articles by unresolved `::open`/`::gap` thread count, with global aggregate footer. Hides when there are zero open gaps. Addresses P1.3.
