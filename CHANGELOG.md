...
- **feat(frontend):** home page gains editorial-gaps and unwritten-pages cards — top 5 articles by unresolved `::open`/`::gap` thread count, plus top 5 wikilink targets with no resolving article. Both have global aggregate footers and hide when zero. Addresses P1.3.
